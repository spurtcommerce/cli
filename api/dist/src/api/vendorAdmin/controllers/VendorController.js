...
let VendorAdminController = class VendorAdminController {
    ...
    documentService, zoneService, industryService, vendorMediaService, 
    // private documentLogService: VendorDocumentLogService,
    vendorOrderService, exportLogService) {
            ...
            if (updateCustomerParam.approvalFlag === 1) {
                if (oldVendorApprovalStatus !== 1) {
                    if (env_1.env.imageserver === 's3') {
                        ...
                        const prefixId = vendorSave.vendorPrefixId.replace('#', '');
                        yield this.imageService.createFolder(prefixId.toLowerCase());
                    }
